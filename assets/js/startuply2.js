            ...
            $.ajax({
                ...
                success: function(msg) {
                    if ( msg.indexOf('Success') != -1 ) {
                        ...
                        var email = $("#email").val();
                        if ( typeof toastr != 'undefined' ) toastr.success('Gracias '+username+'! En unos minutos recibirás un correo a '+email);
                        else if ( $responseBlock.length ) $responseBlock.html('<span class="success-message">Gracias '+username+'! En unos minutos recibirás un correo a '+email'</span>');
